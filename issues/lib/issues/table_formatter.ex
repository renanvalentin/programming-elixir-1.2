defmodule Issues.TableFormatter do
  ...
  indentified by each header. That is, each header identifies a column,
  ...
  hyphens, width + signs where the vertical bar beetween the columns goes.
